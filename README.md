...
<img src="images/action.gif" alt="ChatGPT Interview demo">

## Install

1. Download the latest release: https://github.com/bariskisir/ChatGPTInterview/releases/latest/download/dist.zip
2. Unzip the archive.
...
0. Clone the repository `git clone https://github.com/bariskisir/ChatGPTInterview`
